...
**Leaderboard** is a basic website that allows users to add/remove scores to a table
...
- It let users to add scores in an easy way
...
```
  cd my-folder
  git clone https://github.com/jaimevillegas/leaderboard.git 
```
